...
from utility import format_info_for_csv_lib

theUrl = 'http://books.toscrape.com/catalogue/brain-on-fire-my-month-of-madness_669/index.html'
...
def scrape_response(soup, url):
    ...
    with open('test.csv', 'w') as file:
        ...
        # Writing the infos
        file.write((format_info_for_csv_lib(soup, url)))
